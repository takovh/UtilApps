...
import com.takovh.utilApps.utils.FileUtil;
...
//            System.out.println(flag?"创建成功！":"创建失败！");
     ...
     */
    public void collectCode2File(String basePath, String outputPath) throws FileNotFoundException {
        File baseDir = new File(basePath);
        if(!baseDir.exists()) throw new FileNotFoundException("basePath文件夹不存在！");
        getFileList(baseDir);
